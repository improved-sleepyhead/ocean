    ...
    <div className="max-w-8xl space-y-4 mb-[250px] sm:mb-15 md:mb-0">
      <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold font-montserrat text-[#0059FF]">
        <span className="dark:text-white">
          Твое цифровое пространство <br />
          для идей, проектов и продуктивности. <br />
          Добро пожаловать в{" "}
        </span>
        <span className="bg-gradient-to-r from-[#0059FF] to-[#00DDFF] inline-block text-transparent bg-clip-text font-montserrat  dark:bg-gradient-to-r dark:from-[#640F00] dark:to-[#BC0003]">
          Ocean!
        </span>
      </h1>
      <h3 className="text-base dark:text-white sm:text-xl md:text-2xl font-medium font-montserrat text-[#0059FF]">
        Ведите личные записи, планируйте проекты
        <br />и совместно работайте с командой - всё в одном месте
      </h3>
      {isLoading && (
